...
.bar.bar-positive.bar-footer {
  background-image: linear-gradient(180deg, #000000, #000000 50%, transparent 50%); }
.bar.bar-calm {
  border-color: #0a9ec7;
...
.bar.bar-balanced.bar-footer {
  background-image: linear-gradient(180deg, #28a54c, #000000 50%, transparent 50%); }
.bar.bar-energized {
  border-color: #e6b400;
...
/* scratch css so that we can switch themes for demo */
.delivery-items-header{
  color: #fff;

}

/*thingworx right menu settings styles*/
.thingworx-app-settings a{
  color: #fff;
  text-decoration: none;
}